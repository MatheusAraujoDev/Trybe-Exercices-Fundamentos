//Para resolver os exercícios tome como base o seguinte objeto:
const lesson1 = {
  materia: 'Matemática',
  numeroEstudantes: 20,
...
//Exercício 8.Crie uma função que obtenha o valor da chave de acordo com a sua posição no objeto. Por exemplo:
